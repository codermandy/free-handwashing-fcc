var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-1cy4eur");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@s");
    			attr(div1, "class", "progress-container svelte-1cy4eur");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="handwash.gif" alt="How to wash our hands?" class="svelte-c9l5rn">`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    <a href="https://freesound.org/people/metrostock99/sounds/345086/ ">Sound Source</a>`;
    			...
    			audio_1.innerHTML = `<source src="ohyeah.wav">`;
    			attr(h1, "class", "svelte-1a7la3o");
    			attr(h3, "class", "svelte-1a7la3o");
    		},
    		m(target, anchor) {
